...
export default function About() {
  return (
    <div className="container mx-auto px-4">
      <h1 className="text-5xl font-bold  flex justify-center items-center mt-6">
        ABOUT
      </h1>
      ...
      <p className="mt-8">
        We pride ourselves on offering a vast collection of movies, spanning a
        variety of genres and languages. Whether you&aposre into action-packed
        thrillers, heartwarming dramas, or captivating animations, we have
        something for everyone. Our team works around the clock to ensure that
        our users get access to the latest releases as soon as they become
        available.
      </p>
      <p className="mt-8">
